...
then
  ...
  --batch_size 2 --decoder_embed_dim 64 --decoder_depth 2 --decoder_attn AttentionOrg --encoder_attn AttentionWithCls \
  --batch_size 2 --decoder_embed_dim 64 --decoder_depth 2 \
  --epochs 1 --mask_ratio 0.95 --repeat_aug 2 \
